...
const RUNTIME_FILES = ["incodex-main.cjs","incodex-preload.cjs","incodex-inject.js","incodex-safe-home.cjs","incodex-ipc-guard.cjs","incodex-owner-core.cjs","incodex-owner-recovery.cjs","incodex-instance.cjs","incodex-window-kind.cjs","incodex-window-lifecycle.cjs","incodex-runtime-load.cjs","incodex-codex-mode.cjs","incodex-dock-menu.cjs","incodex-permission-copy.json","incodex-permission-ui.cjs"];
/** @returns {string} */
