...
const ADJECTIVES: [&str; 16] = [
    "Quiet", "Bright", "Gentle", "Hidden", "Amber", "Swift", "Mellow", "Clever", "Soft", "Calm",
    "Nimble", "Kind", "Lunar", "Mild", "Brave", "Cozy",
];
const ANIMALS: [&str; 16] = [
    "Otter", "Badger", "Robin", "Panda", "Fox", "Koala", "Lark", "Finch", "Beaver", "Rabbit",
    "Heron", "Lynx", "Seal", "Wren", "Sable", "Bison",
];
