...
describe("Homebrew tap bump", () => {
  ...
  test("README documents the tap install", () => {
    ...
    expect(readme).toContain("irm https://raw.githubusercontent.com/daftAI2026/incodex/main/install.ps1 | iex");
  ...
  test("README is English and links a Chinese translation", () => {
    ...
    expect(cn).toContain("x86_64 的 Windows 10/11");
    expect(cn).toContain("irm https://raw.githubusercontent.com/daftAI2026/incodex/main/install.ps1 | iex");
    expect(cn).toContain("暂不支持 Linux");
