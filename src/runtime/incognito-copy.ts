...
export const ACCESSIBILITY_SETUP_COPY = {
  ...
  "zh-HK": {
    ...
    addedBody: "將上方 ChatGPT 圖示拖入輔助功能列表並啟用權限。完成 macOS 要求的驗證後，系統會自動檢查權限；檢查完成後，此視窗會自動關閉。",
  ...
  "zh-TW": {
    ...
    later: "稍後",
    addedTitle: "在系統設定中允許 ChatGPT",
    addedBody: "將上方的 ChatGPT 圖示拖曳到輔助功能列表並啟用權限。完成 macOS 要求的驗證後，系統會自動檢查權限；檢查完成後，此視窗會自動關閉。",
