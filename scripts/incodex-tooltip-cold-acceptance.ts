...
export function headerStyleProbeExpression(): string {
  ...
  return `(()=>{
    ...
    const info=e=>{if(!e)return null;const svg=e.querySelector('svg');const props={};for(const a of [...e.attributes])if(a.name==='class'||a.name==='style'||['data-size','data-icon-size','data-gutter-size','data-color','data-variant','data-uniform','data-squircle','data-pill','data-block','data-optically-align'].includes(a.name))props[a.name]=a.value;
